...
def autonomous():
    ...
    right_drive_1.spin_for(FORWARD, 625, wait=False)
    left_drive_1.spin_for(REVERSE, 625, wait=True)
    right_drive_1.set_velocity(70, PERCENT)
    left_drive_1.set_velocity(70, PERCENT)
    ...
    drive_motor_group.spin_for(FORWARD, -400)
    right_drive_1.spin_for(REVERSE, 150, wait=False)
    left_drive_1.spin_for(FORWARD, 150, wait=True)
    cylinder_left.set(True)
    cylinder_right.set(True)
    conveyor_belt_1.spin(FORWARD)
    drive_motor_group.spin_for(FORWARD, 600)
    wait(800)
    left_drive_1.spin_for(FORWARD, 100)
    wait(800)
    conveyor_belt_1.stop()
